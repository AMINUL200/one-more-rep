...
const ProductPage = () => {
  ...
  const gymWearCategories = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?w=800&h=600&fit=crop",
      itemCount: 15,
  ...
  return (
    <>
      <PageHelmet title={`${category} - ONE REP MORE`} />
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1">
                ...
                >
                  Performance apparel designed for serious athletes. Shop the
                  latest collection of training shoes, workout gear, and
                  accessories.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 pb-16">
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p style={{ color: colors.muted }}>
                  Browse our wide range of gym wear categories
                </p>
              </div>
              <Link
                to="/categories"
            ...
            >
              {featuredProducts.map((product) => (
                ...
                >
                  {/* Product Image */}
                  <div
                    className={`relative overflow-hidden ${viewMode === "grid" ? "h-48" : "w-32 h-32 flex-shrink-0"}`}
                  >
                    <img
                      src={product.image}
                      alt={product.name}
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <p style={{ color: colors.muted }}>
                We carry only premium fitness brands
              </p>
            </div>
