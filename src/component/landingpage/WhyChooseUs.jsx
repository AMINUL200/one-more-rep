...
import { Shield, Truck, Award, Headphones, Zap, TrendingUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "100% authentic gym equipment from trusted brands. Every product is quality-tested and certified.",
      stats: "5000+ Reviews"
    },
    {
      id: 2,
      icon: Truck,
      title: "Fast Delivery",
      description: "Free shipping on orders over $100. Get your equipment delivered to your doorstep within 3-5 days.",
      stats: "2-3 Days"
    },
    {
      id: 3,
      ...
      description: "Competitive prices with exclusive deals. We match any lower price you find elsewhere.",
      stats: "Save Up to 40%"
    },
    {
      id: 4,
      icon: Headphones,
      title: "24/7 Support",
      description: "Expert fitness advisors ready to help. Get personalized recommendations and instant support.",
    ...
    },
    {
      ...
      icon: Zap,
      title: "Easy Returns",
      description: "30-day hassle-free returns. Not satisfied? Send it back with no questions asked.",
      stats: "30-Day Policy"
    },
    {
      id: 6,
      ...
      description: "Free workout plans and nutrition guides with every purchase. Track your progress with our app.",
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#B3B3B3] text-lg max-w-3xl mx-auto">
            We're not just a gym equipment store — we're your fitness partner. Here's what makes us stand out from the competition.
          </p>
        </div>
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-[#E10600] to-[#FF0800] rounded-3xl p-12 shadow-[0_0_60px_rgba(225,6,0,0.4)]">
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-[#B3B3B3] mb-8 text-lg">
            Join thousands of athletes who trust One Rep More for their training needs.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-8 py-4 bg-[#E10600] hover:bg-[#FF0800] text-white font-bold rounded-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(225,6,0,0.6)] hover:scale-105">
              Shop Now
            </button>
